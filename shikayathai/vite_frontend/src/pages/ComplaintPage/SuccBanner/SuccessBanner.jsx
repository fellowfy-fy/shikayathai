...
const SuccessBanner = ({ id }) => {
  return ( <div className="w-full max-w-[1680px] h-[179px] rounded-[16px] bg-[#B5F62B4D] mt-[56px] mx-auto p-[20px]">
    ...
    <div className="flex items-center mt-4">
      ...
      <div className="flex items-center ml-[10px] border border-gray-300 rounded-[4px] w-[480px] h-[44px] bg-white">
        <input
          type="text"
