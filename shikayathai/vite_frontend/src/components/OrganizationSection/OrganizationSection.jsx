...
const OrganizationSection = () => {
  ...
  return (
    <section className="text-left md:text-center items-left md:items-center mx-[24px] md:mx-[120px] pb-[40px] pt=[20px] md:pt-40 md:pb-20">
      <div className="mb-8">
        <h2 className="text-[24px] md:text-[32px] font-unbounded font-bold text-[#001A45]">Create Your Organization's Page Today!</h2>
        <div className="text-[18px] md:text-[24px] font-inter font-light mt-2 text-[#001A45]">
          Empower your business by creating a page on our platform. Here's why:
        </div>
      </div>
      <div className="flex flex-col md:flex-row justify-around flex-wrap gap-8 text-left md:text-center items-left md:items-center">
        {[
          ...
          <div className="flex justify-center text-left md:text-center items-left md:items-center flex-col max-w-xs" key={index}>
