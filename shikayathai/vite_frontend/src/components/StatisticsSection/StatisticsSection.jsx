...
const StatisticsSection = () => {
  ...
  return (
    <section className="text-center p-8 bg-gradient-to-b from-[#F7E5FF] to-[#FFE5C6] rounded-lg flex flex-col items-center justify-center gap-8">
      ...
      <h3 className="text-2xl font-bold font-unbounded">in numbers</h3>
      <div className="flex justify-center gap-12 flex-wrap">
        <div className="text-center">
          <h3 className="text-3xl font-bold text-[#001A45] m-0 font-unbounded">1 500 000+</h3>
          <p className="text-xl font-inter font-bold text-gray-700 m-0">active users</p>
        </div>
        <div className="text-center">
          <h3 className="text-3xl font-bold text-[#001A45] m-0 font-unbounded">32 000+</h3>
          <p className="text-xl font-inter font-bold text-gray-700 m-0">active companies</p>
        </div>
        <div className="text-center">
          <h3 className="text-3xl font-bold text-[#001A45] m-0 font-unbounded">8 000 000+</h3>
          <p className="text-xl font-inter font-bold text-gray-700 m-0">resolved requests</p>
        </div>
