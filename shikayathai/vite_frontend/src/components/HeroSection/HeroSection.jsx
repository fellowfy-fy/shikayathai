  ...
  return (
    <section className="bg-[#FFD2BE] w-full rounded-bl-[30px] rounded-br-[30px] px-5 sm:px-24 md:px-30 pt-6">
      <div className="flex flex-col sm:flex-row items-start justify-between">
        <div className="text-left max-w-lg lg:pb-[106px] z-10">
          <h1 className="flex flex-col text-[32px] lg:text-[96px] 2xl:text-[128px] font-unbounded font-bold text-[#001A45] leading-tight">
            <span>FREE</span>
            <span>Complaint</span>
            <span>Platform</span>
          </h1>
          ...
          <button
            className="mt-5 hover:bg-[#C9FF57] text-[#001A45] bg-[#B5F62B] active:bg-[#A9E922] sm:w-[312px] w-[100%] h-[55px] rounded-[12px] font-inter font-medium text-[18px] transition-all mx-auto sm:mx-0 md:mx-0"
