  ...
  return (
    <section className="sm:px-30 px-[120px] py-5 sm:pt-40 sm:pb-20 bg-white">
      <div className="mb-8 text-center">
        <h1 className="text-4xl sm:text-6xl font-unbounded font-bold text-[#001A45]">
          How it works?
        </h1>
        <p className="text-2xl text-[#001A45] font-inter font-semibold mt-2">
          Here, we make sure your complaints get heard and fixed, fast. File
          Your Complaint Easily
        </p>
      </div>
      <div className="flex flex-col md:flex-row justify-around items-center text-center flex-wrap">
        ...
        <img
          src={arrow_up}
          alt="Arrow up"
          className="w-[240px] h-[47px] hidden md:block"
        />
        <div className="flex flex-col items-center mt-24 md:mt-36">
          ...
          <p className="text-[18px] font-inter text-[#001A45]">
            We handle the details, contacting the company and making your case
            public.
          </p>
        </div>
        <img
      ...
      <div className="text-center mt-12">
        <button
          className="mt-5 hover:bg-[#C9FF57] bg-[#B5F62B] active:bg-[#A9E922] sm:w-[312px] w-[100%] h-[55px] rounded-[12px] text-[18px] transition-all"
