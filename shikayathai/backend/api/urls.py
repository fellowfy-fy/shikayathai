...
from .views import UserDetailUpdateDeleteView, ComplaintDetailUpdateDeleteView, CompanyDetailUpdateDeleteView, CreateComplaintView, CreateCompanyView, ListComplaintsView, CommentListCreateView
