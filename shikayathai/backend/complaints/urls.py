...
from .views import ComplaintAndCompanyCreateView, ComplaintDashboardView, ComplaintDetailView, ListComplaintsView, CommentCreateView, CommentListView, UserComplaintsView, MarkAsResolvedView, ListSolvedComplaintsView
...
urlpatterns = [
    ...
    path('list/solved/', ListSolvedComplaintsView.as_view(), name='list-complaints'),
